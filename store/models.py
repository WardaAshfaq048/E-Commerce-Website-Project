...
class Contact(models.Model):
    name = models.CharField(max_length=100)  # Full name of the contact
    email = models.EmailField(unique=True)   # Email address of the contact
    phone = models.CharField(max_length=15, blank=True, null=True)  # Optional phone number
    message = models.TextField()             # Message sent by the contact
